...
--
-- Host: localhost
-- Generation Time: Mar 02, 2015 at 11:44 PM
...
CREATE TABLE `tbl_l_companyuser` (
...
CREATE TABLE `tbl_l_criteriametric` (
...
--
-- Table structure for table `tbl_l_metricstep`
--

CREATE TABLE `tbl_l_metricstep` (
...
--
-- Dumping data for table `tbl_l_metricstep`
--

INSERT INTO `tbl_l_metricstep` (`metricstep_id`, `metric_id`, `step_id`, `metricstep_principle`, `metricstep_description`, `metricstep_gaps`, `metricstep_actions`, `metricstep_responsibility`, `metricstep_completiondate`, `metricstep_comments`, `metricstep_status`) VALUES
(1, 1, 1, 1, 'test description', 'test gaps', 'test actions', 1, '2015-03-02 21:31:26', 'test comments', 1);
...
CREATE TABLE `tbl_l_principlestep` (
...
INSERT INTO `tbl_l_principlestep` (`principlestep_id`, `principle_id`, `metricstep_principle`) VALUES
(1, 1, 1);
...
INSERT INTO `tbl_user` (`user_id`, `user_username`, `user_firstname`, `user_lastname`, `user_position`, `user_department`, `user_phone`, `user_email`, `user_address`, `user_password`, `user_privileges`) VALUES
(1, 'testuser', 'testfirst', 'testlast', 'testposition', 'testdepartment', '555-555-5555', 'test@test.com', '321 Blast Off.', 'password', 2);
